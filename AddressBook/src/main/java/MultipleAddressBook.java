...
public class MultipleAddressBook {
    ...
    /***
     * created sortAddressBook method sort person by name
     */
    public void sortAddressBook() {
        for (String i : multipleAddressBookMap.keySet()) {
            Map<String, Person> con = multipleAddressBookMap.get(i).multipleAddressBook.personMap;
            List<Person> sorted = con.values().stream()
